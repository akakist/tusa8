========================================================================
    ACTIVEX CONTROL DLL : w32 Project Overview
========================================================================

ControlWizard has created this project for your w32 ActiveX Control
...
that make up your w32 ActiveX Control DLL.
...
w32.ico
    ...
    is included by the main resource file w32.rc.

/////////////////////////////////////////////////////////////////////////////
Cw32Ctrl control:

w32Ctrl.h
    This file contains the declaration of the Cw32Ctrl C++ class.

w32Ctrl.cpp
    This file contains the implementation of the Cw32Ctrl C++ class.

w32PropPage.h
    This file contains the declaration of the Cw32PropPage C++ class.

w32PropPage.cpp
    This file contains the implementation of the Cw32PropPage C++ class.

Cw32Ctrl.bmp
    This file contains a bitmap that a container will use to represent the
    Cw32Ctrl control when it appears on a tool palette.  This bitmap
    is included by the main resource file w32.rc.
...
stdafx.h, stdafx.cpp
    ...
    named w32.pch and a precompiled types (PCT) file named stdafx.obj.
